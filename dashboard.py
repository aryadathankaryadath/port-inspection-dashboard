...
def load_authority_data():
    try:
        df = pd.read_excel("/Users/aryadathankaryadth/PycharmProjects/port-inspection-dashboard/final.xlsx")
        return df
...
def load_ship_data():
    try:
        ship_df = pd.read_excel("/Users/aryadathankaryadth/PycharmProjects/port-inspection-dashboard/ship data.xlsx")
        return ship_df
    except Exception as e:
